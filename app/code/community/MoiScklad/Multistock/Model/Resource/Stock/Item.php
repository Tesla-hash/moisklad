 ...
 * @author RUGENTO
 */
class Rugento_Multistock_Model_Resource_Stock_Item extends Mage_CatalogInventory_Model_Resource_Stock_Item
{
    /**
    ...
    public function addCatalogInventoryToProductCollection($productCollection)
    {
        ...
        $productCollection->getSelect()->where('cisi.stock_id = 1'); //XXX RUGENTO
        return $this;
    }
}